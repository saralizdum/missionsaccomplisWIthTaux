...
//
////
////    @Query(value = "SELECT distinct r, (SELECT (sum (r.tauxavancement * r.ponderation)) /(sum (r.ponderation)) FROM Recommandation r) FROM Recommandation r group by r.incharge"
////    )
//////
//////    Double sum();
////////
////
////   List<Recommandation> sum();
